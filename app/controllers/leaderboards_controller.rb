class LeaderboardsController < ApplicationController
  ...
  def index
    @leaderboards = Leaderboard.where(user_id: session[:user_id], genre_id: params[:genreid], subgenre_id: params[:subgenreid],)
  end
  ...
  private
    ...
    def leaderboard_params
      params.require(:leaderboard).permit(:user_id, :genre_id, :subgenre_id, :score_id)
    end
end
