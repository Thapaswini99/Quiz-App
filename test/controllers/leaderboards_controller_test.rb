...
class LeaderboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leaderboard" do
    assert_difference('Leaderboard.count') do
      post leaderboards_url, params: { leaderboard: { genre_id: @leaderboard.genre_id, score_id: @leaderboard.score_id, subgenre_id: @leaderboard.subgenre_id, user_id: @leaderboard.user_id } }
    end
  ...
  test "should update leaderboard" do
    patch leaderboard_url(@leaderboard), params: { leaderboard: { genre_id: @leaderboard.genre_id, score_id: @leaderboard.score_id, subgenre_id: @leaderboard.subgenre_id, user_id: @leaderboard.user_id } }
