...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { Score: @score.Score, subgenre_id: @score.subgenre_id, user_id: @score.user_id } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { Score: @score.Score, subgenre_id: @score.subgenre_id, user_id: @score.user_id } }
